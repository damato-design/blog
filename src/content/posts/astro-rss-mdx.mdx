...
Again, you'll probably want to add some additional metadata to your feed, maybe filter and sort the posts too. You could probably construct that data in a similar way to the approach taken for `link` above. This is basically I create [the feed at this very site](/feed.xml).
